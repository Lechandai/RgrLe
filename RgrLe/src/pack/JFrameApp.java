...
public class JFrameApp extends JFrame {
	...
	public JFrameApp() {
		...
		// добавляем в него стандартные кнопки
		// (свернуть, закрыть, развернуть на весь
		// экран
		...
		setTitle("Calculator");
		// Создаем панель на которой будем
		// размещать все наши кнопки
		JPanelApp panelApp = new JPanelApp();
		// добавлем панель в окно
		getContentPane().add(panelApp);
		// говорим что нужно показать окно
		// нашего приложения
		setVisible(true);
	}
